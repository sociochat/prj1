import { Building2, Award, MapPin, Settings } from 'lucide-react';
      ...
      <div>
        <div className="fixed top-4 right-4 z-50">
          <button
            ...
            className="bg-white text-gray-700 px-4 py-2 rounded-lg shadow-lg hover:shadow-xl transition-shadow font-semibold"
          >
            Back to Clients
          </button>
        </div>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-cyan-50 via-blue-50 to-white">
        <div className="container mx-auto text-center">
          ...
          <button
            ...
            className="inline-flex items-center space-x-2 bg-cyan-600 text-white px-6 py-3 rounded-lg hover:bg-cyan-700 transition-colors font-semibold"
          >
